...
Devise.setup do |config|
  ...
  config.saml_configure do |settings|
    ...
    if Rails.application.secrets.sso_idp_certificate.present?
      ...
      settings.idp_cert_fingerprint               = Rails.application.secrets.sso_idp_cert_fingerprint
      settings.idp_cert_fingerprint_algorithm     = Rails.application.secrets.sso_idp_cert_fingerprint_algorithm
    end
